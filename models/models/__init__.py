...
def setup(opt, model_name, caption = True):
    if caption:
        ...
        elif model_name == 'denseatt2in2':
            model = DenseAtt2in2Model(opt)
        ...
        elif model_name == 'attn_topdown':
            model = ATTN_TopDownModel(opt)
        elif model_name == 'attn_topdown1':
            model = ATTN_TopDownModel1(opt)
        elif model_name == 'topdown_cut_line':
            model = TopDownModel_cut_line(opt)
        elif model_name == 'topdown0':
            model = TopDownModel0(opt)
        elif model_name == 'topdown1':
            model = TopDownModel1(opt)
        elif model_name == 'adatopdown1':
            model = AdaTopDownModel1(opt)
        elif model_name == 'topdown2':
            model = TopDownModel2(opt)
        else:
